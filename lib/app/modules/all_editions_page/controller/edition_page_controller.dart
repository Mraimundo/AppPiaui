...
@Injectable()
class AllEditionPageController = _AllEditionPageControllerBase
    with _$AllEditionPageController;

abstract class _AllEditionPageControllerBase with Store {
  ...
  _AllEditionPageControllerBase(this._repository) {
    init();
  }
